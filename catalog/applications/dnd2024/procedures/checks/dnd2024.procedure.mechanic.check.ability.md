...
governs: dnd2024.mechanic.check.ability; an action resolving its raw fixed-DC check
status: active
---
...
Source: `dnd2024.source.srd-5.2.1`, `Playing the Game > D20 Tests > Ability Checks > Ability Modifier/Difficulty Class` (PDF p. 6). The automatic 20/1 text reviewed at `Playing the Game > D20 Tests > Attack Rolls > Rolling 20 or 1` (PDF p. 7) is attack-only and is not applied here.
