...
governs: dnd2024.mechanic.saving-throw; dnd2024.mechanic.species-origin-traits.read; an action resolving an imposed fixed-DC character save
status: active
---
...
1. Accept an exact ability ID and integer DC, with an optional governed condition, explicit D20 roll circumstances, or voluntary failure.
...
- A save identified as resisting or ending the Charmed condition automatically receives Fey Ancestry advantage from the active selected-species definition.
