---
id: dnd2024.procedure.mechanic.species-profile
category: dnd2024.ruleset.core.data.species-profile
...
1. Attach `dnd2024.species-profile` only to an entity whose
   ...
   agree exactly.
2. Use permanent `dnd2024.content.species.<key>.v<version>` identities. Correct static facts through
...
3. Record Humanoid type, permitted Size values, base five-mode Speed facts, and ordered trait and
   choice-family declarations from `dnd2024.source.srd-5.2.1`, *Character Origins > Character
