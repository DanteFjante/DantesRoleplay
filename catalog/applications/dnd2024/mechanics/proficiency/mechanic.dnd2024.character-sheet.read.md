...
```json
{"roles":{"subject":{"components":["dnd2024.abilities","dnd2024.character-level","dnd2024.skill-proficiencies","dnd2024.saving-throw-proficiencies"],"description":"The character whose source-backed core sheet numbers are derived."}}}
```
