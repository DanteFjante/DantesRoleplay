...
return {narration:world.name+' advances by '+ctx.input.minutes+' minutes.',effects:[{type:'component.set',entityId:world.id,definitionId:CLOCK,data:JSON.stringify(next)}],events:[],notifications:[],data:{test:'dnd2024-world-clock-advance',worldId:world.id,minutes:ctx.input.minutes,calendarId:next.calendarId,previousMinute:clock.currentMinute,currentMinute:next.currentMinute,previousRevision:clock.revision,currentRevision:next.revision}};
