...
```json
{"roles":{"creature":{"components":["dnd2024.creature.hit-points","dnd2024.rest-episode"],"description":"Creature starting one rest episode."},"world":{"components":["dnd2024.game.core.world.root","dnd2024.game.core.world.clock"],"includeRelationships":true,"description":"Active base-application root whose clock supplies the start coordinate."},"policy":{"components":["dnd2024.rest-policy"],"description":"Canonical immutable standard-rest policy."}}}
```
