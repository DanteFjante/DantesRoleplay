...
var state={kind:ctx.input.kind,contentKey:ctx.input.contentKey,contentVersion:ctx.input.contentVersion,status:ctx.input.status,sourceRef:{sourceId:'source.dnd2024.srd-5.2.1',locator:ctx.input.locator}};
