...
- Rule source: `dnd2024.source.srd-5.2.1`, locator `Playing the Game > D20 Tests > Attack Rolls > Armor Class` in System Reference Document 5.2.1.
...
3. Fix `sourceRef` to `{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Playing the Game > D20 Tests > Attack Rolls > Armor Class"}`.
4. Create active `dnd2024.mechanic.armor-class.write` in scope `dnd2024-srd-5.2.1`. It declares role `subject` and may inspect that component when present.
