...
- Rule source: `dnd2024.source.srd-5.2.1`, locator `Equipment > Weapons > Weapon Proficiency`, PDF page 89 in System Reference Document 5.2.1.
...
3. Fix `sourceRef` to `{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Equipment > Weapons > Weapon Proficiency"}`.
4. Create active `dnd2024.mechanic.weapon-proficiencies.write` in scope `dnd2024-srd-5.2.1`. It declares role `subject` and may inspect that component when present.
