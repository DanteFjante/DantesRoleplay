...
- Rule source: `dnd2024.source.srd-5.2.1`, locator `Equipment > Weapons`, PDF pages 89–91 in System Reference Document 5.2.1.
...
3. Fix `sourceRef` to `{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Equipment > Weapons"}`.
4. Create active `dnd2024.mechanic.weapon-profile.write` in scope `dnd2024-srd-5.2.1`. It declares role `weapon` and may inspect that component when present.
5. Import canonical entities `dnd2024.weapon.dagger`, `dnd2024.weapon.shortbow`, and `dnd2024.weapon.battleaxe`, each with exactly one profile component.
