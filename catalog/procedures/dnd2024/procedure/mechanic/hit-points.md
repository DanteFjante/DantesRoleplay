...
- Rule source: `dnd2024.source.srd-5.2.1`, locator `Playing the Game > Damage and Healing > Hit Points` in System Reference Document 5.2.1.
...
3. Fix `sourceRef` to `{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Playing the Game > Damage and Healing > Hit Points"}`.
4. Create active `dnd2024.mechanic.hit-points.write` in scope `dnd2024-srd-5.2.1`. It declares role `subject` and may inspect that component when present.
