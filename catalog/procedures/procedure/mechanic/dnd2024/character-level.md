...
- Rule source: source.dnd2024.srd-5.2.1, locator "Character Creation > Character Advancement" in System Reference Document 5.2.1.
...
Dependencies
- procedure.mechanic.dnd2024.source-registry and entity source.dnd2024.srd-5.2.1.
...
3. sourceRef is fixed to {"sourceId":"source.dnd2024.srd-5.2.1","locator":"Character Creation > Character Advancement"}.
4. Create mechanic.dnd2024.character-level.record in scope dnd2024-srd-5.2.1. It declares subject and may see dnd2024.character-level when already present.
...
- The source reference is fixed to source.dnd2024.srd-5.2.1 and Character Creation > Character Advancement; callers cannot supply or override it.
- Normal creation and correction use mechanic.dnd2024.character-level.record, so invalid values fail before effects. Direct effects are reserved for an explicitly governed migration.
