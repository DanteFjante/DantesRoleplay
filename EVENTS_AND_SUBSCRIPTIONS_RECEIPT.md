...
The design record is [EVENTS_AND_SUBSCRIPTIONS_PLAN.md](EVENTS_AND_SUBSCRIPTIONS_PLAN.md) — why
each piece is shaped the way it is, and the acceptance matrix each slice was held to. This document
is the shorter question: what exists now, what it refuses to do, and what a reader should not have
to rediscover.
