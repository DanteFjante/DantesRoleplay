...
- Matching host/Tools were built from `0654cbb0`. Review configuration explicitly selects installed Codex 0.153.4 and Sol; the two real review outcomes above remain retained. No candidate has passed review yet and no live feature write has occurred.
