...
status: active
revised-by: Claude Fable 5, 2026-08-17 — scoped governs to the kernel and added the redirect, so run_action callers stop retrieving instructions they cannot follow
---
...
engine. If you are calling `run_action` over MCP, this is not your contract — read
`procedure.mechanic.run` instead; the runner performs all of this for you.
