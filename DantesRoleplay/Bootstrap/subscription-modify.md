...
4. Use `status: "disabled"` to take a registration out of future routing and `status: "archived"` to hide it from ordinary lists. This has no runtime effect until routing exists.
...
- This contract does not authorize implementing or claiming event execution.
