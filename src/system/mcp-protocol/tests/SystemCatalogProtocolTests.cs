...
public sealed class SystemCatalogProtocolTests : IDisposable
{
    ...
    public async Task Empty_provider_discloses_nothing_and_capabilities_publish_only_confirmed_system_writes()
    {
        ...
        Assert.Equal(
            ["system.application-object.submit", "system.application.activate", "system.application.register", "system.blob-upload.begin", "system.blob-upload.finalize", "system.component-type.register", "system.conversation-memory", "system.extension.register", "system.interaction-execute", "system.interaction-recipe-review", "system.knowledge-state.sync", "system.namespace.register", "system.source.register", "system.state-space.adopt-legacy", "system.state-space.create", "system.state-space.upgrade", "system.trigger-scheduling", "system.world-state.sync"],
