...
for (const target of targets) {
  ...
  const contractExport = target.contractOnly
    ? `export const contract = ${JSON.stringify({ id: query.id, outputSchemaHash: query.executor === "object-projection" ? objectOutputSchemaHash(query.outputSchema) : query.projection.outputSchemaHash })};\n`
