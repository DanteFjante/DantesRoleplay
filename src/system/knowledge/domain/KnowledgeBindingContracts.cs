...
public sealed record KnowledgeParticipationResolution(bool Active, string Revision, bool ActorMissing = false)
{
    public static KnowledgeParticipationResolution Denied() => new(false, "");
    public static KnowledgeParticipationResolution MissingActor() => new(false, "", true);
}
