...
public sealed class Dnd2024ApplicationReadViewTests
{
    ...
    public async Task Character_dossier_joins_recorded_origin_features_inventory_and_provenance_without_private_rules_text()
    {
        ...
        const string sheet = """
        {"version":2,"subject":{"id":"actor.caldris.ganji","label":"Ganji"},"identity":{"biography":"A quiet acolyte seeking a merciful path."},"origin":{"species":{"id":"dnd2024.content.species.half-elf.v1","label":"Half Elf V1"},"background":{"id":"dnd2024.content.background.acolyte.v1","label":"Acolyte V1"}},"classes":[{"id":"membership.ganji.monk","name":"Monk membership","class":{"id":"dnd2024.content.class.monk.v1","label":"Monk V1"},"level":1,"subclass":null}],"level":1,"proficiencyBonus":2,"abilities":[{"ability":{"id":"str","label":"Strength"},"score":10,"modifier":0}],"savingThrows":[],"skills":[],"hitPoints":{"current":9,"maximum":9,"maximumReduction":0},"armorClass":{"value":15},"features":[{"feature":{"id":"dnd2024.content.feature.monk.martial-arts.v1","label":"Martial Arts V1"},"grantedBy":{"id":"dnd2024.content.class.monk.v1","label":"Monk V1"},"grantKind":{"id":"class-feature","label":"Class Feature"},"classLevel":1},{"feature":{"id":"dnd2024.content.feature.monk.unarmored-defense.v1","label":"Unarmored Defense V1"},"grantedBy":{"id":"dnd2024.content.class.monk.v1","label":"Monk V1"},"grantKind":{"id":"class-feature","label":"Class Feature"},"classLevel":1},{"feature":{"id":"dnd2024.content.feature.magic-initiate.v1","label":"Magic Initiate"},"grantedBy":{"id":"dnd2024.content.background.acolyte.v1","label":"Acolyte V1"},"grantKind":{"id":"origin-feat","label":"Origin Feat"},"classLevel":null}],"inventory":{"items":[{"id":"item.ganji.quarterstaff","name":"Ganji's Quarterstaff","definition":{"id":"dnd2024.equipment.weapon.quarterstaff","label":"Quarterstaff V1"},"quantity":1,"slot":"inventory","parentItemId":null,"order":0,"depth":1,"childCount":0,"deeperContentsOmitted":false,"equipmentSlots":[]},{"id":"item.ganji.carving-knife","name":"Ganji's Carving Knife","definition":{"id":"dnd2024.equipment.tool.carving-knife","label":"Carving Knife V1"},"quantity":1,"slot":"inventory","parentItemId":null,"order":1,"depth":1,"childCount":0,"deeperContentsOmitted":false,"equipmentSlots":[]}],"contentsDepth":4,"mayOmitDeeperContents":true},"wallet":{"coinCount":0,"copperValue":0,"gpCount":0,"denominations":[]}}
        """;
        const string levelOneRules = """
        {"test":"character-level-one-rules-project","subjectId":"actor.caldris.ganji","armorClass":{"value":15,"eligible":true,"selected":true,"mechanicId":"dnd2024.mechanic.armor-class.monk-unarmored","activationCapabilityId":null},"attacks":[{"label":"Unarmed Strike","abilityChoices":["str","dex"],"damageDie":"1d6","actionCapabilityId":"dnd2024.mechanic.monk.martial-arts.attack"}],"senses":[{"id":"dnd2024.vocabulary.sense.darkvision","rangeFeet":60,"sourceDefinitionId":"dnd2024.content.species.half-elf.v1"}],"savingThrowCircumstances":[{"test":"saving-throw","againstCondition":"charmed","kind":"advantage","source":"species:fey-ancestry"}],"spellAccess":{"accessibleSpellIds":[],"configurationComplete":false},"equipment":{"existingItemIds":["item.ganji.carving-knife","item.ganji.quarterstaff"],"reconciled":false,"nextCapabilityId":"dnd2024.mechanic.starting-equipment.adopt-existing"},"entitlements":[{"ownerDefinitionId":"dnd2024.content.species.half-elf.v1","entitlementKey":"trait:darkvision","status":"active","reason":null,"mechanicId":"dnd2024.mechanic.species-origin-traits.read","nextCapabilityId":null,"knownValues":{},"missingValues":[],"source":{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Character creation entitlement"}},{"ownerDefinitionId":"dnd2024.content.feature.magic-initiate.v1","entitlementKey":"behavior:configuration:cleric","status":"pending","reason":"behavior-unimplemented","mechanicId":null,"nextCapabilityId":"dnd2024.mechanic.magic-initiate.configure","knownValues":{"spellList":"cleric"},"missingValues":["spellcastingAbility","cantripOne","cantripTwo","levelOneSpell"],"source":{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Character creation entitlement"}},{"ownerDefinitionId":"dnd2024.content.class.monk.v1","entitlementKey":"behavior:martial-arts","status":"active","reason":null,"mechanicId":"dnd2024.mechanic.monk.martial-arts.read","nextCapabilityId":"dnd2024.mechanic.monk.martial-arts.attack","knownValues":{},"missingValues":[],"source":{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Character creation entitlement"}},{"ownerDefinitionId":"dnd2024.content.class.monk.v1","entitlementKey":"behavior:unarmored-defense","status":"active","reason":null,"mechanicId":"dnd2024.mechanic.armor-class.monk-unarmored","nextCapabilityId":null,"knownValues":{},"missingValues":[],"source":{"sourceId":"dnd2024.source.srd-5.2.1","locator":"Character creation entitlement"}}]}
        """;
        var projection = new MechanicProjection
        {
            Input = "{}",
        ...
        Assert.Equal("dnd2024.mechanic.magic-initiate.configure", data.GetProperty("features")[2].GetProperty("implementation").GetProperty("nextCapabilityId").GetString());
        Assert.Equal(15, data.GetProperty("sheet").GetProperty("armorClass").GetProperty("value").GetInt32());
