...
## Instructions
Source and scope
- Use source.dnd2024.srd-5.2.1. The save rule cites "Playing the Game > D20 Tests > Saving Throws"; proficiency membership cites "Playing the Game > Proficiency > Saving Throw Proficiencies".
- This governs only fixed-DC character saves in scope dnd2024-srd-5.2.1. It is deliberately separate from procedure.mechanic.dnd2024.check.ability: a saving throw is selected by an imposed danger and derives proficiency only from dnd2024.saving-throw-proficiencies, never skills. It does not define the danger, its consequences, or class-based acquisition.
