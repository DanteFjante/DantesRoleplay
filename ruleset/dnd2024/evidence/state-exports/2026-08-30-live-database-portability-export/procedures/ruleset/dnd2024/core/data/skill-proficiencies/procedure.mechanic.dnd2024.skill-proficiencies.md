...
- Skill state cites source.dnd2024.srd-5.2.1 at "Playing the Game > Proficiency > Skill Proficiencies and Skills".
- Saving-throw state cites source.dnd2024.srd-5.2.1 at "Playing the Game > Proficiency > Saving Throw Proficiencies".
...
Recording mechanics
5. mechanic.dnd2024.skill-proficiencies.record and mechanic.dnd2024.saving-throw-proficiencies.record are the normal creation and correction paths, both scoped to dnd2024-srd-5.2.1.
