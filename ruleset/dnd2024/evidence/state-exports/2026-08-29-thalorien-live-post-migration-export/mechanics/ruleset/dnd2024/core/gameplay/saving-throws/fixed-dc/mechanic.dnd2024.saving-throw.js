var A={str:"Strength",dex:"Dexterity",con:"Constitution",int:"Intelligence",wis:"Wisdom",cha:"Charisma"},O=["str","dex","con","int","wis","cha"],SID="source.dnd2024.srd-5.2.1",LL="Character Creation > Character Advancement",SL="Playing the Game > Proficiency > Saving Throw Proficiencies",s=ctx.roles.subject,i=ctx.input;
