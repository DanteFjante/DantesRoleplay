...
Status: **Features 1–16 verified; Feature 17 Slice 1 verified; Feature 23 accepted; Feature 28 Slices 1–4 accepted in scope; the remaining rows are planned backlog**
...
| 12 | Action economy: Action, Bonus Action, Reaction, interaction, and Move are spent and restored | Feature 11 | **Verified** — [implementation receipt](feature-12/FEATURE-12-IMPLEMENTATION-RECEIPT.md) | Legendary/lair actions, multiattack routines, and which rule costs which resource |
| 13 | SRD conditions: apply, list, clear, and enforce their effects on checks, saves, and attacks | Feature 12 | **Verified** — [receipts](feature-13/) | Homebrew conditions, species-based immunity, non-SRD stacking, Exhaustion (Feature 14), and every positional condition effect |
| 14 | Exhaustion levels and their D20 Test and speed effects | Feature 13; E1 | **Verified** — [receipts](feature-14/) | Recovery pacing (Feature 33) and death at level 6 (Feature 17) |
| 15 | Damage types with resistance, immunity, and vulnerability in SRD order | Features 9, 13; E1 | **Verified** — [receipts](feature-15/); confirmed weapon damage now applies mitigation and records overkill | Damage transfer, shared damage, absorption, half-damage-on-a-save |
| 16 | Temporary Hit Points and healing, including no-stacking rules | Features 6, 15; E1 | **Verified** — [receipts](feature-16/); buffers absorb mitigated damage before Hit Points and healing clamps without affecting them | Timed regeneration, healing over time, and every source of healing |
...
| 20 | Position and movement: speed, distance, difficult terrain, and reach as attack preconditions | Features 11–12, 23; E1 and confirmed derived-input composition | **Slices 1–5 verified** — bounded maps, placement, reach, tactical admission, atomic paths, difficult terrain, and creature-space passage are installed; [Slice 5 receipt](feature-20/FEATURE-20-SLICE-5-MOVEMENT-RECEIPT.md). | Rendered grid, pathfinding, flanking, elevation/3D terrain |
...
| 23 | Equipment and inventory: item entities, containment, currency, and supported carrying rules | Feature 7 | **Accepted** — bounded physical inventory, carrying, equipment, currency, and fixed item activities are implemented; [receipts](feature-23/) | Shopping economy, crafting, item durability |
| 24 | Armor, shields, armor training, and Armor Class derived from equipped items | Features 3, 6, 12, 20, 23; confirmed Armor Class migration | **Slices 1–4 accepted** — source-backed definitions, closed training state, direct equipped armor/Shield aggregation, and derived AC used by combat; effects, Speed, and timing remain blocked — [plan](feature-24/FEATURE-24-DEPENDENCY-PLAN.md), [receipts](feature-24/) | Every natural-armor formula and magical stacking exception |
...
| 28 | Character-origin foundation: language/tool proficiency state, then backgrounds, feats, and ability-score improvements | Feature 2 for Slice 1; Feature 27 for later grant resolution | **Slices 1–4 accepted in scope** — language/tool membership, Soldier ability-increase resolution, Common-plus-two origin languages, and static Alert/Savage Attacker identities are available; actor grants and active feat behavior remain blocked — [plan](feature-28/FEATURE-28-DEPENDENCY-PLAN.md), [receipts](feature-28/) | Non-SRD feats; language/tool checks, crafting, and feature effects |
...
| 33 | Rests: short/long rest, Hit Dice, resource recovery, and expiry | Features 14, 16, 27, 31; core world clock; confirmed event/recovery composition | **Slices 1–2 accepted in scope** — immutable policy plus one bounded active/ready rest episode are available; interruptions and recovery remain blocked — [plan](feature-33/FEATURE-33-DEPENDENCY-PLAN.md), [receipts](feature-33/) | Gritty-realism and other optional rest variants |
...
| 39 | Heroic Inspiration: one held instance, source-specific grants, and authorised reroll composition | CH1 profile marker; Features 3–5, 8–9; Feature 33 for Human Resourceful | **Slice 1 accepted in scope** — profile-gated one-instance presence state and a grant-only recorder; source grants and reroll composition remain blocked — [plan](feature-39/FEATURE-39-DEPENDENCY-PLAN.md), [receipt](feature-39/FEATURE-39-SLICE-1-RECEIPT.md) | Character creation, rest timing, recipient/party selection, Alert/Savage Attacker, arbitrary rerolls, and copied D20 logic |
...
- **Feature 24 derives final AC rather than updating it as an equipment side effect.** Its
  derived reader now supplies current Weapon Attack and Unarmed Strike; the Feature 6 manual writer
  is a deprecated historical record. Feature 20 still owns heavy-armor effective Speed and a later
  clock owner still owns minute-based don/doff completion.
