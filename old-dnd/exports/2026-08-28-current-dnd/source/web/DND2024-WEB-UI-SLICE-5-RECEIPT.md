...
The user's subsequent instructions to continue through campaign selection and then begin the next
planned web-UI slice accept the completed Order 5/E1 boundary. The next ordered leaf is Order 6
character/inventory mutation controls.
