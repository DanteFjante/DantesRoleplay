...
asset. Its remaining Slices 3–7 — live World/Region maps, city maps, Location reference views,
optional reviewed generated imagery, and campaign knowledge overlays — are planned in the
[scoped map views dependency tree](../prototype/dnd2024/planning/DND2024-SCOPED-MAP-VIEWS-DEPENDENCY-TREE.md),
and all four remain blocked on owners that do not yet exist. Encounter/Initiative authoring, weapon attack/damage, and an interactive tactical
