...
near-duplicate warnings, and the current shared suite reported 1,404 tests passing with no failures;
the separately retained Local AI baseline reports 21 tests. Run acceptance commands against the
same worktree rather than copying this count into another plan.
...
| D&D 2024 | Code-adoption Slices 0–13 accepted selected scope. The 737-file old implementation is retained as fingerprinted recovery/provenance evidence with zero runtime consumers; all numbered adoption work is closed, while incomplete gameplay stays in independent feature gates | [ruleset/dnd2024/ROADMAP.md](ruleset/dnd2024/ROADMAP.md) |
...
| Character/items | Inventory and the basic-playable D&D creation root are accepted: Acolyte, Criminal, Sage, or Soldier can combine with any of twelve SRD level-1 class models; fixed background skills/tools/Common, optional exact Standard-language/Soldier-tool and Bard/Monk class-tool choices, durable source-bound background/class feature identities, exact armor-training and complete/restricted weapon membership, Alert Initiative Proficiency, and the legal all-cash equipment alternative as one physical contained Gold Piece stack are verified with campaign participation, replay/rollback, and an explicit no-behavior pending ledger. Initiative Swap, source-complete spell/exertion adapters, remaining class/feat mechanics, equipped-armor/weapon-property consequences, finish/recovery, Resourceful, and equipment packages remain open | [D&D 2024 character-creation dependency tree](ruleset/dnd2024/DND2024-CHARACTER-CREATION-DEPENDENCY-PLAN.md), [CC3D1A receipt](ruleset/dnd2024/evidence/DND2024-CHARACTER-CREATION-CC3D1A-RECEIPT.md), [CC3F1 receipt](ruleset/dnd2024/evidence/DND2024-CHARACTER-CREATION-CC3F1-RECEIPT.md), [ITEMS_AND_INVENTORY_PLAN.md](ITEMS_AND_INVENTORY_PLAN.md) |
| Knowledge/retrieval | Knowledge state, timeline, lexical/vector retrieval, and bounded local orchestration have receipts; the current modular tree now owns the authorized application-ECS core, fixed loopback Orban audience, activated binding, exact participation, atomic reviewed-state synchronization, and safe notebook projection. Eleven exact Orban facts are live at activation revision 3; no baseline, rumour, clue, or secret was granted | [Knowledge and facts](knowledge/KNOWLEDGE_AND_FACTS_PLAN.md), [D&D web combined 7D2–7D3 receipt](web/DND2024-WEB-UI-SLICE-7D2-7D3-RECEIPT.md) |
| Private web workspace | Shared navigation, system/application chat scopes, system controls, and live Home/Control pages are accepted; the D&D player viewport now includes Character, Scene, Knowledge, Campaign, and Combat. Knowledge is campaign-scoped, searchable/filterable, keyboard-accessible, and verified not to expose canonical IDs or excluded secrets. The next information-first leaves are a display-only known-place map and reviewed place/person imagery | [Slice H receipt](web/WEB-APPLICATION-AWARE-WORKSPACE-SLICE-H-RECEIPT.md), [D&D Slice 7C receipt](web/DND2024-WEB-UI-SLICE-7C-RECEIPT.md), [D&D combined 7D2–7D3 receipt](web/DND2024-WEB-UI-SLICE-7D2-7D3-RECEIPT.md) |
