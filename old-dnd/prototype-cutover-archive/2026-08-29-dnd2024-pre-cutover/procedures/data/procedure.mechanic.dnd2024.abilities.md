...
governs: component definition dnd2024.creature.ability-scores; any mechanic deriving its modifier
status: active
---
...
1. Attach one `dnd2024.creature.ability-scores` component to a creature with exactly `str`, `dex`, `con`, `int`, `wis`, and `cha`, each an integer from 1 through 30.
