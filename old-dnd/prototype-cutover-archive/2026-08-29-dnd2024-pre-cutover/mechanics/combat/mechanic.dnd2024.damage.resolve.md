...
```json
{"roles":{"defender":{"components":["dnd2024.creature.defenses"],"description":"The creature whose absent, known-empty, or valid mitigation state is reported."}},"children":{"stateEffects":{"mechanicId":"mechanic.dnd2024.d20-test.state-effects","roleBindings":{"subject":"defender"},"inheritInput":true}}}
```
