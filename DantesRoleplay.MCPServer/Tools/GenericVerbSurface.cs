...
public static class VerbSurface
{
    ...
    [
        ...
        new("system.application-preview", "Authenticated disposable scan and candidate overlay preview for one registered application.", ["applicationId", "limit"], ["procedure.system.inspect"]),
    ...
    [
        ...
        new("system.application.activate", "Activate an exact valid source-overlay preview with authenticated replay protection.", "{requestToken, applicationId, previewFingerprint, expectedActiveFingerprint}", "{\"requestToken\":\"0123456789abcdef0123456789abcded\",\"applicationId\":\"example\",\"previewFingerprint\":\"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",\"expectedActiveFingerprint\":null}", true, ["procedure.system.use"]),
    ...
    public static IReadOnlyDictionary<string, string> QueryParameters { get; } = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["sourceIds"] = "Information source filter.", ["applicationId"] = "One registered non-system application.",
