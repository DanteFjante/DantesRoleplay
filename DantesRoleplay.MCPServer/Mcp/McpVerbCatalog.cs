...
public static class McpVerbCatalog
{
    ...
    private const string DirectApplicationActionOutputSchema = """
        ...
        """;
    private const string ConversationMemoryCommitInputSchema = """
        {"type":"object","additionalProperties":false,"required":["payload"],"properties":{"payload":{"type":"object","additionalProperties":false,"required":["operation","applicationId","stateSpaceId","sessionContextId","sourceProjectId","repositoryRoot","sourceThreadId","requestToken"],"properties":{"operation":{"enum":["connect","append","retry","disconnect","archive","delete","derive"]},"applicationId":{"type":"string","minLength":1,"maxLength":63},"stateSpaceId":{"type":"string","minLength":1,"maxLength":200},"sessionContextId":{"type":"string","minLength":1,"maxLength":200},"sourceProjectId":{"type":"string","minLength":1,"maxLength":200},"repositoryRoot":{"type":"string","minLength":1,"maxLength":1024},"sourceThreadId":{"type":"string","minLength":1,"maxLength":200},"sourceTurnId":{"type":"string","minLength":1,"maxLength":200},"messages":{"type":"array","minItems":2,"maxItems":32,"items":{"type":"object","additionalProperties":false,"required":["sourceMessageId","role","sourceKind","text","sourceAtUtc"],"properties":{"sourceMessageId":{"type":"string","minLength":1,"maxLength":200},"role":{"enum":["user","assistant"]},"sourceKind":{"enum":["user-prompt","assistant-commentary","assistant-final"]},"text":{"type":"string","minLength":1,"maxLength":16000},"sourceAtUtc":{"type":"string"}}}},"captureProvenance":{"type":"string","minLength":1,"maxLength":1000},"capturedAtUtc":{"type":"string"},"requestToken":{"type":"string","minLength":1,"maxLength":128},"failureCode":{"type":"string","minLength":1,"maxLength":100},"messageId":{"type":["string","null"],"maxLength":80},"taskId":{"type":"string","minLength":1,"maxLength":200},"commandId":{"type":"string","minLength":1,"maxLength":128},"sourceRevision":{"type":"integer","minimum":1},"sourceMessageIds":{"type":"array","minItems":1,"maxItems":64,"uniqueItems":true,"items":{"type":"string","minLength":1,"maxLength":200}}}},"intent":{"type":"string"},"proceduresUsed":{"type":"array","items":{"type":"string"}},"dryRun":{"type":"boolean","const":false}}}
        """;
    ...
    [
        ...
        new("system.applications", "Authenticated bounded inspection of registered applications and revisions.", ["applicationId", "limit"], ["procedure.system.application-lifecycle"]),
        new("system.sources", "Authenticated bounded inspection of registered relative sources and latest scan evidence.", ["applicationId", "id", "limit"], ["procedure.system.application-lifecycle"]),
        new("system.application-preview", "Authenticated disposable scan and candidate resolution preview for reviewed base sources plus registered extensions.", ["applicationId", "sourceIds", "extensionIds", "limit"], ["procedure.system.application-lifecycle"]),
        new("system.application-readiness", "Authenticated operational diagnostics for independently versioned application registration, activation, catalog, query, web-page, and audience owners.", ["applicationId"], ["procedure.system.application-lifecycle"]),
        new("system.application-object", "Read one exact parameterized registered application object with authorized source evidence.", ["applicationId", "stateSpaceId", "id", "entityId", "request"], ["procedure.system.inspect"]),
        new("system.dependencies", "Authenticated declared component-field and projection dependency impact for one application.", ["applicationId", "id", "transitive", "limit"], ["procedure.system.application-lifecycle"]),
        ...
        new("system.trigger-scheduling", "Privately inspect current schedules, observations, past fires, phone devices, sources, and structures.", ["applicationId", "resource", "id", "limit"], ["procedure.system.trigger-scheduling"]),
        new("system.conversation-memory", "Privately inspect one explicitly linked application gameplay-session conversation journal.", ["applicationId", "stateSpaceId", "request"], ["procedure.system.conversation-memory"]),
    ...
    [
        ...
        new("system.application-object.submit", "Submit one partial or complete registered application object through its declared reverse mappings.", "{\"applicationId\":\"example\",\"stateSpaceId\":\"example-space\",\"qualifiedQueryId\":\"example.query.object\",\"entityId\":\"entity.example\",\"idempotencyKey\":\"object-submit.example.1\",\"expectedSourceRevisionFingerprint\":\"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",\"input\":{},\"mode\":\"object\",\"object\":{}}", false, ["procedure.system.use"]),
        ...
        new("system.conversation-memory", "Connect, capture, retry, disconnect, archive, delete, or retain one completed dream for a private application gameplay-session conversation journal.", "{\"operation\":\"connect\",\"applicationId\":\"example\",\"stateSpaceId\":\"example-space\",\"sessionContextId\":\"session.example\",\"sourceProjectId\":\"project.example\",\"repositoryRoot\":\"C:\\\\repo\\\\example\",\"sourceThreadId\":\"thread.example\",\"requestToken\":\"memory.connect.example.1\"}", false, ["procedure.system.conversation-memory"], ConversationMemoryCommitInputSchema),
