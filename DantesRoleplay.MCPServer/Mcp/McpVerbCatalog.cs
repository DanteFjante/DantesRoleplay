...
public static class McpVerbCatalog
{
    ...
    [
        ...
        new("system.namespace.register", "Register one new catalog namespace so identities may be authored beneath it. It arrives needing review; nothing may be written into it until a person reviews it.", "{id, owner, description, allowedKinds}", "{\"id\":\"mechanic.example.thing\",\"owner\":\"example\",\"description\":\"Mechanics for the example thing.\",\"allowedKinds\":[\"mechanic\"]}", true, ["procedure.system.namespace"]),
